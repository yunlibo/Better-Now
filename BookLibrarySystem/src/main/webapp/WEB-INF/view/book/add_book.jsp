...
<div class="data-book thumbnail span6 clearfix">
	<div class="caption clearfix">
		...
		<form class="form-horizontal add-book-form" action="addBook.do" method="POST">
			...
			<div class="control-group">
				<label class="control-label" for="inputTranslator">译者</label>
				<div class="controls">
					<input type="text" id="inputTranslator" name="translator" onblur="validateInput(this)"> <span class="help-inline"></span>
				</div>
			</div>
			...
			<div class="control-group">
				<label class="control-label" for="inputPrice">单价</label>
				<div class="controls">
			...
			<!-- 操作员 -->
			<div class="control-group">
				<label class="control-label" for="inputCzy">操作员</label>
				<div class="controls">
					<input type="text" id="inputCzy" name="czy" onblur="validateInput(this)"> <span class="help-inline"></span>
				</div>
			</div>
			<!-- 条形码 -->
			<div class="control-group">
				<label class="control-label" for="inputTxm">条形码号</label>
				<div class="controls">
					<input type="text" id="inputTxm" name="txm" onblur="validateInput(this)"> <span class="help-inline"></span>
				</div>
			</div>
			<div class="control-group">
	...
	$(".search-isbn").click(function(){
		...
		$.post(baseUrl + "book/searchBookByISBN.do",
				...
				function(data){
					...
					$("#inputCzy").val(data['czy']);
					$("#inputTxm").val(data['txm']);
					$("#inputType").val(data['bookType']);
					$("#inputAuthor").val(data['author'].join(" "));
					$("#inputTranslator").val(data['translator'].join(" "));
