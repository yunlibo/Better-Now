...
<div class="container">
	...
	<div>
		...
		<div style="float:left;margin-left:10px;">
			...
			<p><span class="p1">借阅次数: </span>${book.borrowedNumber }</p>
			<p><span class="p1">状态:</span>${book.bookzt } </p><0.不在架 1.在架></p>
			<p><span class="p1">库存量: </span>${book.number }</p>
		</div>
	</div>
