...
<div>
	...
	<div class="data-borrower thumbnail" style="width:50%;float:left;display:none;">
		<div class="caption borrower-caption">
			<h1 class="borrower-name">浅梦彡<small class="borrower-sex">男</small></h1>
			<hr>
			<p>卡号:<span class="borrower-card-number">2</span></p>
			<p>电话号码:<span class="borrower-phone">1234567</span></p>
			<p>身份证号码:<span class="borrower-id-card">440782199509133911</span></p>
			<p>工作单位: <span class="borrower-work-place">黑龙江科技大学</span></p>
			<p>地址:<span class="borrower-address">黑龙江科技大学学生宿舍14栋505</span></p>
