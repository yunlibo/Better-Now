...
<div class="container">
	<div class="tabbable">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="${basePath }user/manageUser.do">管理员管理</a></li>
		</ul>
	</div>
	<!-- tab-panes -->
			...
			<form class="form-horizontal form-add-user" action="addUser.do" method="POST">
				<div class="control-group">
					<div class="controls" style="margin-left:30px;">
						<input type="text" id="input-username" name="username" placeholder="用户名">
